...
CREATE TABLE `tbl_horas` (
  ...
  CONSTRAINT `id_tareah` FOREIGN KEY (`id_tarea`) REFERENCES `tbl_tarea` (`id`),
  CONSTRAINT `legajo_empleado` FOREIGN KEY (`legajo_empleado`) REFERENCES `tbl_empleado` (`legajo`)
